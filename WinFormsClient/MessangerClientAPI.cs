...
namespace MyMessanger
{
    class MessangerClientAPI
    {
        ...
        public void TestNewtonsoftJson()
        {
            ...
            Messange msg = new Messange("RusAl", "Privet", DateTime.UtcNow);
        ...
        public Messange GetMessage(int MessageId)
        {
            ...
            {
                Messange deserializedMsg = JsonConvert.DeserializeObject<Messange>(responseFromServer);
                //Console.WriteLine(deserializedMsg);
        ...
        public async Task<Messange> GetMessageHTTPAsync(int MessageId)
        {

            var responseString = await client.GetStringAsync("http://localhost:5000/api/Messanger/" + MessageId.ToString());
            if (responseString != null)
            {
                Messange deserializedMsg = JsonConvert.DeserializeObject<Messange>(responseString);
                return deserializedMsg;
            }
            return null;
        }
        ...
        public bool SendMessange(Messange msg)
        {
        ...
        /*public bool SendMessageRestSharp(Messange msg)
        {
